...
export default function SessionDetailScreen() {
  ...
  const handleCounterTime = async () => {
    ...
    try {
      ...
      // Also update question status to indicate waiting for student
      await fetch(`/api/questions/${session?.questionId}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ status: "PendingStudentConfirmation" })
      });
  ...
  console.log("session.tutorCounterTime:", session.tutorCounterTime);
  console.log("session.finalTime:", session.finalTime);
  console.log("session.status:", session.status);
  console.log("hasTutorCounter:", hasTutorCounter);
  console.log("canStudentConfirm:", canStudentConfirm);
